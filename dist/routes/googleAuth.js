...
route.get("/success", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.isAuthenticated()) {
        ...
        return res.redirect(`${process.env.CLIENT_URL}/dashboard?payload=${encodeURIComponent(token || "")}&email=${(user === null || user === void 0 ? void 0 : user.email) || ""}&name=${(user === null || user === void 0 ? void 0 : user.name) || ""}&firstName=${(user === null || user === void 0 ? void 0 : user.firstName) || ""}&lastName=${(user === null || user === void 0 ? void 0 : user.lastName) || ""}&address=${(user === null || user === void 0 ? void 0 : user.address) || ""}&phonenumber=${(user === null || user === void 0 ? void 0 : user.phoneNumber) || ""}&country=${(user === null || user === void 0 ? void 0 : user.country) || ""}`);
    }
    else {
